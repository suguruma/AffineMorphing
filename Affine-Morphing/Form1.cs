...
namespace MakeupSim
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                CurImageName = openFileDialog3.FileName;
                pictureBox4.Image = Image.FromFile(CurImageName);
                location_image = CurImageName;
                //target_image = CurImageName;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                location_pts = openFileDialog4.FileName;
